...
const phaseInfo = {
  mounting: {
    label: "Mounting Disks",
    description: "Preparing disks for scanning...",
    icon: Clock,
  ...
  scanning: {
    label: "Scanning",
    description: "Analyzing disk contents...",
    icon: RotateCw,
  ...
  analyzing: {
    ...
    description: "Analyzing scan findings...",
    icon: RotateCw,
...
export const ScanStatus = React.forwardRef<HTMLDivElement, ScanStatusProps>(({
  logs,
  onClearLogs,
  status,
  phase,
        ...
        <div className="p-4 space-y-1">
          {logs.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-32 text-gray-500">
              ...
              <p className="text-xs">Scan logs will appear here</p>
            </div>
          ) : (
            <div className="relative">
              ...
              {(phase === 'scanning' || phase === 'analyzing') && (
                <div className="sticky bottom-0 left-0 right-0 p-2 bg-slate-50/95 border-t border-gray-100 flex items-center justify-center">
          ...
          <HoverCardContent className="w-80">
            <div className="space-y-2">
              ...
              <div className="text-sm space-y-1">
                ...
                <p className="text-blue-600">ℹ️ Scan operations</p>
